...
| [Day 3](https://github.com/steyou/advent-of-code-2025/blob/b834784062e4db37926fa578a34bee2bc9db4dc6/day3.go) | <p>**Part 1** Do two passes scanning from the right to the left: the first to find the leftmost highest number and the second to find the highest number "before" it</p><p>**Part 2** Instead use a single right-to-left loop to mutate a walking left-to-right stopping point.</p> |
| [Day 4](https://github.com/steyou/advent-of-code-2025/blob/b834784062e4db37926fa578a34bee2bc9db4dc6/day4.go) | Unremarkable algorithm that is implemented as you'd expect: just use a sliding window. Part 2 is barely different by only needing to mutate the grid in-memory after every pass. |
